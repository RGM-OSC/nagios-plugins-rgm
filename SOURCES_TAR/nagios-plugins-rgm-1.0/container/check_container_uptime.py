...
def get_custom_api_url(prometheus_host, container_name, interval_start):
	...
	prometheus_query = urllib.quote("container_start_time_seconds{name=~\"" + container_name + "\"}")
...
if __name__ == '__main__':
	...
	* Uptime request is handled by API REST againt Prometheus.
	...
	parser.add_argument('-i', '--intervalstart', type=int, help='timestamp value in seconds to start the Uptime check - default to 6min', default=int(time.time())-360)
