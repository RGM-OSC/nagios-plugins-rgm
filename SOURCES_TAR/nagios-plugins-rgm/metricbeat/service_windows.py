...
def rgm_service_output(warning_treshold, critical_treshold, data_validity, verbose, total_hit, display_name, service_status, reverse):
    try:
        # Get Memory values:
        retcode = 3
...
if __name__ == '__main__':
    ...
    if validate_elastichost(args.elastichost):
        ...
        rgm_service_output(args.warning, args.critical, args.timeout, args.verbose, total_hit, display_name, service_status, args.reverse)
