...
def rgm_insight_output(clearpass_host, client_id, client_secret):
    try:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        ...
        Check insight configuration of "clearpass1" Clearpass Server
            python check_clearpass_API_insight.py -H clearpass1 -u user -i clientID -s clientSecret
        """,
    ...
    rgm_insight_output(args.hostname, args.clientID, args.clientSecret)
